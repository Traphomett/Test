...
class DealershipsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @dealership = dealerships(:dealershep1)
  end
  ...
  test "should create dealership" do
    assert_difference("Dealership.count") do
      post dealerships_url, params: { dealership: { direccion: @dealership.direccion, nombre: @dealership.nombre, telefono: @dealership.telefono } }
    end
  ...
  test "should update dealership" do
    patch dealership_url(@dealership), params: { dealership: { direccion: @dealership.direccion, nombre: @dealership.nombre, telefono: @dealership.telefono } }
